...
/** Array with all parsed commON records */
  ...
  /** Constructor. It takes the commON CSV file content as input.
      ...
      @param $content commON CSV file content
...
*/
  ...
  /** Generate a RDF file serialized in N3 by using the parsed commON records and the related linkage schema.
      ...
      @param $baseInstance  Base URI of the instance records to be converted
      @param $baseOntology  Base URI of the ontology used to create new attributes and types. This is used
...
/** Return the URI of the property that has been linked to a commON attribute by the Linkage Schema.
    ...
    @param $targetAttribute Target attribute, from the commON file, that we try to link to an external vocabulary/schema/ontology 
...
/** Return the URI of the type that has been linked to a commON type by the Linkage Schema.
    ...
    @param $targetType Target type, from the commON file, that we try to link to an external vocabulary/schema/ontology 
...
*/
  ...
  /** Apply N3 serialization escaping rules to a literal
      ...
      @param $literal Literal to be escaped 
