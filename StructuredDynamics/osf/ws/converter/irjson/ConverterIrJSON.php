...
class ConverterIrJSON extends \StructuredDynamics\osf\ws\framework\WebService
{
  ...
  /**   Custom linkage schema used to include within the dataset's description when no linkage schemas exists
  ...
  /** Constructor
      ...
      @author Frederick Giasson, Structured Dynamics LLC.
  */
  function __construct($document = "", $docmime = "application/iron+json", $include_dataset_description="false")
  {
    parent::__construct();
