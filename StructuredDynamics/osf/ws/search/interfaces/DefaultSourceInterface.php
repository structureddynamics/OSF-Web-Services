      ...
      if($this->ws->conneg->getStatus() == 200)
      {
        ...
        if($this->ws->memcached_enabled)
        {
          $memcachedKey = $this->ws->generateCacheKey('search', array(
            ...
            $this->ws->page,
            $this->ws->inference,
            $this->ws->includeAggregates,
            $this->ws->attributesBooleanOperator,
            $this->ws->aggregateAttributesObjectType,
            $this->ws->aggregateAttributesNb,
            $this->ws->resultsLocationAggregator,
            $this->ws->lang,
            $this->ws->defaultOperator,
            $this->ws->attributesPhraseBoost,
            $this->ws->phraseBoostDistance,
            $this->ws->searchRestrictions,
            $this->ws->includeScores,
            $this->ws->spellcheck,
            $this->ws->extendedFilters,
            $this->ws->typesBoost,
            $this->ws->attributesBoost,
            $this->ws->includeAttributesList,
            $this->ws->datasetsBoost,
            $this->ws->aggregateAttributes,
            $this->ws->types,
            $this->ws->datasets,
            $this->ws->distanceFilter,
            $this->ws->rangeFilter,
            $this->ws->sort,
            $accessibleDatasets));
