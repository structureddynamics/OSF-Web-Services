...
/*! @file \StructuredDynamics\structwsf\ws\converter\bibtex\ConverterBibtex.php
...
use \StructuredDynamics\structwsf\ws\converter\bibtex\BibtexParser;
use \StructuredDynamics\structwsf\ws\converter\bibtex\BibtexParserCsv; 

/** Convert Bibtex data into RDF. This class takes Bibtex files as input, convert 
    them into RDF using the BKN Ontology, and output RDF in different formats.
...
class ConverterBibtex extends \StructuredDynamics\structwsf\ws\framework\WebService
{
  /** Database connection */
  private $db;
...
/** Get a prefix for a given ontology URI. This function return the prefix literal for a given 
    ontologu URI. This is a simple procedure that associate an Ontology URI to its "generally 
    used prefix".

    @attention All the data ingested by a conStruct node has to define a prefix for the ontologies used to describe any data.
           
    @param $uri is the URI of a class or a property of an ontology
