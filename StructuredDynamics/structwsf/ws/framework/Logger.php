...
/*! @file \StructuredDynamics\structwsf\ws\framework\Logger.php
...
class Logger
{
    ...
    $requestProcessingTime, $requestHttpResponseStatus, $requesterUserAgent = "")
  {
    ...
    $this->db = new DBVirtuoso($data_ini["triplestore"]["username"], $data_ini["triplestore"]["password"],
