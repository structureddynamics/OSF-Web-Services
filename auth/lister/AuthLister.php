...
class AuthLister extends WebService
{
	...
	*/	
	public function injectDoctype($xmlDoc)
	{
		...
		$xmlDoc = substr($xmlDoc, 0, $posHeader)."\n<!DOCTYPE resultset PUBLIC \"-//Structured Dynamics LLC//Auth Lister DTD 0.1//EN\" \"".$this->dtdBaseURL.$this->dtdURL."\">".substr($xmlDoc, $posHeader, strlen($xmlDoc) - $posHeader);	
	...
	public function process()
	{
		...
		if($this->conneg->getStatus() == 200)
		{
			...
			{		
				...
				{
					$query = "	select distinct ?ws from <".$this->wsf_graph.">
									where
									{
