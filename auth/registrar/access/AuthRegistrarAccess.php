...
class AuthRegistrarAccess extends WebService
{
	...
	*/		
	...
	{
		$this->conneg = new Conneg($accept, $accept_charset, $accept_encoding, $accept_language, AuthRegistrarAccess::$supportedSerializations);

		if(strtolower($this->action) != "create" && strtolower($this->action) != "delete_target" && strtolower($this->action) != "delete_all" && strtolower($this->action) != "update")
		{
