...
*/
	...
	private $bibProperties = array(	// Standard BIBTEX
													...
													"isbn" => "bibo:isbn",
													"editor" => "bibo:editor",
													"institution" => "dcterms:contributor",
													"volume" => "bibo:volume",
													"url" => "bkn:url",
													"type" => "dcterms:type",
													...
													"honor" => "foaf:page",
													"born_date" => "foaf:birthdate",
													"death_date" => "bio:event",
													"image" => "foaf:page",
													"memorial" => "foaf:page",
													"biography" => "foaf:page",
													"url" => "bkn:url",
													"author_tex" => "bkn:authorTex",
													"title_tex" => "bkn:titleTex",
													"coden" => "bibo:coden",
													"sici" => "bibo:sici",
													"mrclass" => "bkn:mrClass",
													"mrnumber" => "bkn:mrNumber",
													"arxiv" => "bkn:arxiv",
													"euclid" => "bkn:euclid",
													"id_ar" => "bkn:ar",
													"msc_mr" => "bkn:mscmr",
													"comment" => "skos:note",
													"comment_post" => "skos:note",
													"rev" => "dcterms:modified",
													"date" => "dcterms:date",
													"subjectTitle" => "skos:prefLabel",
													"subjects" => "umbel:isAbout",
...
//													"howpublished_ar" => "dcterms:publisher",
	...
	private $bibPropertiesAdditionalObjects = array(	// Standard BIBTEX
																				...
																				"memorial" => array("bkn:Memorial", "bkn:url"),
																				"biography" => array("bkn:Biography", "bkn:url"),
																				"bibliography" => array("bkn:Bibliography", "bkn:url"),
	...
	*/		
	...
	{
		$this->conneg = new Conneg(	$accept, $accept_charset, $accept_encoding, $accept_language, ConverterBibtex::$supportedSerializations);
