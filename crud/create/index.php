...
$logger = new Logger("crud_create", $requester_ip, "?document=".substr($document, 0, 64)."&mime=".$mime."&dataset=".$dataset."&registered_ip=".$registered_ip."&requester_ip=$requester_ip", $_SERVER['HTTP_ACCEPT'], $start_datetime, $totaltime, $ws_crudcreate->pipeline_getResponseHeaderStatus(), $_SERVER['HTTP_USER_AGENT']);
