...
$logger = new Logger("crud_read", $requester_ip, "?uri=".$uri."&dataset=".$dataset."&include_linksback=".$include_linksback."&registered_ip=".$registered_ip."&requester_ip=$requester_ip", $_SERVER['HTTP_ACCEPT'], $start_datetime, $totaltime, $ws_cr->pipeline_getResponseHeaderStatus(), $_SERVER['HTTP_USER_AGENT']);
