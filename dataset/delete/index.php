...
$ws_dd->ws_conneg($_SERVER['HTTP_ACCEPT'], $_SERVER['HTTP_ACCEPT_CHARSET'], $_SERVER['HTTP_ACCEPT_ENCODING'], $_SERVER['HTTP_ACCEPT_LANGUAGE']);
...
$logger = new Logger("dataset_delete", $requester_ip,  "?uri=".$uri."&registered_ip=".$registered_ip."&requester_ip=$requester_ip", $_SERVER['HTTP_ACCEPT'], $start_datetime, $totaltime, $ws_dd->pipeline_getResponseHeaderStatus(), $_SERVER['HTTP_USER_AGENT']);
