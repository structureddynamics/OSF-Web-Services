...
/*!@file \ws\framework\Resultset.php
...
class Resultset
{
  ...
  */    
  private $resultset = array();
    ...
    /*! @brief Prefixes used by the resultset */
  ...
  /*! @brief Number of new prefixes that have been added to the list of prefixes */
  private $newPrefixesCounter = 0;                       
  
  /*! @brief Folder where the structWSF instance is installed */
  ...
  */
  ...
  /*! @brief Convert an internal structWSF resultset array structure in structXML 
  ...
  */  
  ...
  /*! @brief Convert an internal structWSF resultset array structure in structJSON 
  ...
  */  
  ...
  /*! @brief Convert an internal structWSF resultset array structure in irON JSON 
  ...
  */   
  ...
  /*! @brief Convert an internal structWSF resultset array structure in irON commON 
  ...
  */     
  ...
  /*! @brief Convert an internal structWSF resultset array structure in RDF+XML
  ...
  */  
  ...
  /*! @brief Convert an internal structWSF resultset array structure in RDF+N3
...
class Subject
{
  /*! @brief URI of the suject */
  private $uri = "";

  /*! @brief Internal array description of the subject. */
