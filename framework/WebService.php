 ...
 */
  ...
  /*! @brief Specifies if the structWSF instance is geo-enable, which means
             that the geo-Solr index is used, and that geo-related queries
             can be used. */
  protected $geoEnabled = FALSE;

  /*! @brief Internal resultset array structure used by all web service endpoints.
...
*/
  ...
  */
  ...
  /*! @brief Core web service serializations supported by all structWSF web service
  ...
  */
  ...
  /*! @brief Check if a given IRI is valid.
              
      @param[in] $iri The IRI to validate
