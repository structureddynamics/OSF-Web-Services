...
$logger = new Logger("sparql", $requester_ip, "?query=".$query."&dataset=".$dataset."&registered_ip=".$registered_ip."&requester_ip=$requester_ip", $_SERVER['HTTP_ACCEPT'], $start_datetime, $totaltime, $ws_sparql->pipeline_getResponseHeaderStatus(), $_SERVER['HTTP_USER_AGENT']);
